...
from magicdrive.dataset.syntheocc.dataset_nusmtv import NuScenesDatasetMtvSpar

@DATASETS.register_module()
class SyntheOccNuScenesDatasetM(NuScenesDataset):
# class SyntheOccNuScenesDatasetM(NuScenesDatasetM):
    r"""NuScenes Dataset.
    ...
    def __getitem__(self, idx):
        ...
        while True:
            ...
            # data['syntheocc'] = self.syntheocc_train_dataset[idx]
