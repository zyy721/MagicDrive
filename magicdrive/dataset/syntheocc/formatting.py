...
from magicdrive.dataset.unipad.formatting import Collect3D
...
#     def __init__(self,
#                  unipad_keys,
#                  unipad_meta_keys=('cam_intrinsic',
...
#         self.unipad_keys = unipad_keys
#         self.unipad_meta_keys = unipad_meta_keys

#     def __call__(self, results, data):
...
#         data['unipad'] = {}
#         img_metas = {}
#         for key in self.unipad_meta_keys:
#             if key in results:
...
#         data['unipad']['img_metas'] = DC(img_metas, cpu_only=True)
#         for key in self.unipad_keys:
#             data['unipad'][key] = results[key]
...
@PIPELINES.register_module(force=True)
class SyntheOccCollect3D(Collect3D):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(SyntheOccCollect3D, self).__init__(**kwargs)
    ...
    def __call__(self, results):
        ...
        data = super(SyntheOccCollect3D, self).__call__(results)
        data['syntheocc'] = results['syntheocc']
