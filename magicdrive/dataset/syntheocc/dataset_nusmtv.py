...
class NuScenesDatasetMtvSpar(torch.utils.data.Dataset):
    def __init__(self, args, tokenizer, trainorval):
        ...
        # dataroot = "/home/yzhu/SyntheOcc/data/nuscenes"
        self.save_name = 'samples_syntheocc_surocc'
    ...
    def get_data_dict(self, curr_info):
        ...
        for cam_id in range(6):
            ...
            # ctrl_img = ctrl_img.toarray().reshape((in_cha, 224, 400))
            ctrl_img = ctrl_img.toarray().reshape((in_cha, 28, 50))
