...
# from magicdrive.misc.test_utils_reconstruct import (
#     prepare_all, run_one_batch
# )

from magicdrive.misc.test_utils_syntheocc import (
    prepare_all, run_one_batch
)
...
@hydra.main(version_base=None, config_path="../configs",
            config_name="syntheocc_test_config")
def main(cfg: DictConfig):
    ...
    # pipe, val_dataloader, weight_dtype, InferUVTRSSL_cls = prepare_all(cfg)
